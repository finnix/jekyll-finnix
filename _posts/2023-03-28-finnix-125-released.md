...
Today marks the release of [Finnix](https://www.finnix.org/) 125, the original utility live Linux distribution. Finnix 125 includes a number of fixes, new packages and new features:
  ...
  * New packages: 2048, aespipe, iperf3 ([finnix/finnix#37](https://forge.colobox.com/finnix/finnix/issues/37)), ncdu, netcat-traditional, ninvaders, vitetris
...
---
  ...
  * [Release data](https://forge.colobox.com/finnix/finnix-docs/src/HEAD/releases/125.json)
