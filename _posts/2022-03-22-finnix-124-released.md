...
Finnix 124 includes a number of fixes, new packages and new features:
  ...
  * RISC-V (riscv64) unofficial build support added, in addition to amd64, i386, arm64, armhf, ppc64el, s390x. (Though as a reminder, AMD64 is the only officially supported architecture with released ISOs. For more information, see [Platform support on Finnix](https://forge.colobox.com/finnix/finnix-docs/src/HEAD/platforms.md).)
  ...
  * Added new packages:
    * [inxi](https://packages.debian.org/testing/inxi) ([finnix/finnix#23](https://forge.colobox.com/finnix/finnix/issues/23))
    * [rmlint](https://packages.debian.org/testing/rmlint) ([finnix/finnix#24](https://forge.colobox.com/finnix/finnix/issues/24))
    * [nwipe](https://packages.debian.org/testing/nwipe) ([finnix/finnix#25](https://forge.colobox.com/finnix/finnix/issues/25))
    * [rename](https://packages.debian.org/testing/rename) ([finnix/finnix#26](https://forge.colobox.com/finnix/finnix/issues/26))
    * [gdu](https://packages.debian.org/testing/gdu) ([finnix/finnix#27](https://forge.colobox.com/finnix/finnix/issues/27))
...
---
  ...
  * [Release data](https://forge.colobox.com/finnix/finnix-docs/src/HEAD/releases/124.json)
