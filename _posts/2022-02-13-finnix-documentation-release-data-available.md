...
The [finnix-docs repository](https://forge.colobox.com/finnix/finnix-docs) has a number of pieces of current documentation which have been ported over from the old Finnix wiki.

In addition, [release data is now available](https://forge.colobox.com/finnix/finnix-docs/src/HEAD/releases) in a consistent machine-parsable JSON format.
